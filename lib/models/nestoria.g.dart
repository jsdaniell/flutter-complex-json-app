...
class _$NestoriaSerializer implements StructuredSerializer<Nestoria> {
  ...
  @override
  Iterable<Object> serialize(Serializers serializers, Nestoria object,
  ...
  @override
  Nestoria deserialize(Serializers serializers, Iterable<Object> serialized,
      {FullType specifiedType = FullType.unspecified}) {
        ...
        case 'listings':
          result.listings.replace(serializers.deserialize(value,
                  specifiedType: const FullType(
                      BuiltList, const [const FullType(Property)]))
...
class _$Nestoria extends Nestoria {
  ...
  factory _$Nestoria([void Function(NestoriaBuilder) updates]) =>
  ...
  @override
  Nestoria rebuild(void Function(NestoriaBuilder) updates) =>
...
class NestoriaBuilder implements Builder<Nestoria, NestoriaBuilder> {
  ...
  @override
  void update(void Function(NestoriaBuilder) updates) {
